...
import { FileMainEreaBodyKanbanColumnSubtask, FileMainEreaBodyKanbanColumnTaskHeader, FileMainEreaBodyKanbanColumnTaskProps, FileMainEreaBodyKanbanColumnTaskFooter } from '.'
            ...
            <ul className='file-mainerea__body__kanban__colmun__task__list'>
                {
                    ...
                    tasks.map((task) => (
                        <li key={task.id} className='file-mainerea__body__kanban__colmun__task__list__item'>
                            <FileMainEreaBodyKanbanColumnTaskHeader catagory={task.catagory} />
