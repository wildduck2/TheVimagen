...
export type Component = WelcomeEmailProps;
  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        <Img
          src={
            'https://zpgqhogoevbgpxustvmo.supabase.co/storage/v1/object/public/produc_imgs/emailLodgo.png'
          }
          width="170"
          height="50"
          alt="Koala"
          ...
          <>
            <Section style={btnContainer}>
              ...
              <Text style={paragraph}>
                Thanks for starting the new TheVimagen account creation process.
                We want to make sure it's really you. Please enter the following
                verification code when prompted. If you don&apos;t want to
                create an account, you can ignore this message.
              </Text>
              <Section
                style={{ placeContent: 'center', ...verificationSection }}
              >
