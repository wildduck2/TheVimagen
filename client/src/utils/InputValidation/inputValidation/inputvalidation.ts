...
export const PasswordValidation = ({ passwordComfirmValue, inputsValid, setvalid, inputValue, dispatch, setPasswordInRange, setPasswordShowMenu, setPasswordHasNumber, setPasswordHasLowercase, setPasswordHasUppercase, setPasswordHasSpecialCharacter, setvalidcomf }: PasswordValidationType) => {
...
export const PasswordComfirmValidation = ({ setvalid, passwordValue, inputValue, dispatch, inputsValid }: PasswordComfirmValidationType) => {
