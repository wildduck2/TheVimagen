        ...
        >
            <AccordionItem value="open">
                ...
                <AccordionContent data-state={open}>
                    ...
                    <iframe
                        srcDoc={`<style>* {  scrollbar-width: thin; html{ height: fit-content; }}</style>${sanitizedContent}`}
                    />
                </AccordionContent>
            </AccordionItem>
        </Accordion>
    ) : (
        <iframe srcDoc={`<style>* {  scrollbar-width: thin; html{ height: fit-content; }}</style>${sanitizedContent}`} />
    )
}
