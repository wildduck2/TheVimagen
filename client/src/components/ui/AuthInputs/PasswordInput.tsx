...
type PasswordInputProps = { isLoading: boolean, password: string, setPassword: setValueFunc, setPasswordcomfirmationValid: setValidType, passwordComfirmValue: string }

export const PasswordInput = ({ isLoading, password, setPassword, setPasswordcomfirmationValid, passwordComfirmValue }: PasswordInputProps) => {
